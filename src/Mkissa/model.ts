...
/**
 * The run this source reads.
 *
 * The site publishes each chapter under a translation type, and every query here asks for
 * the same one — the chapter list and the page list have to agree, or a chapter opens to
